...
class PiperFollower(Robot):
    ...
    def is_connected(self) -> bool:
        """
        检查机械臂CAN port和相机是否都已连接。
        """
        return self.robot.get_connect_status() and all(cam.is_connected for cam in self.cameras.values())
    ...
    def get_observation(self) -> dict[str, Any]:
        ...
        obs_dict = {
            "joint_1": jnt_state_raw.joint_1*PiperFollowerConfig.MDEGREE_TO_RAD,
            "joint_2": jnt_state_raw.joint_2*PiperFollowerConfig.MDEGREE_TO_RAD,
            "joint_3": jnt_state_raw.joint_3*PiperFollowerConfig.MDEGREE_TO_RAD,   
            "joint_4": jnt_state_raw.joint_4*PiperFollowerConfig.MDEGREE_TO_RAD,
            "joint_5": jnt_state_raw.joint_5*PiperFollowerConfig.MDEGREE_TO_RAD,
            "joint_6": jnt_state_raw.joint_6*PiperFollowerConfig.MDEGREE_TO_RAD,
            "gripper": gripper_state_raw.grippers_angle*PiperFollowerConfig.UM_TO_MM,
